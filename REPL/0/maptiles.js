...
tiles[16] = new google.maps.GroundOverlay(
 "http://terramapadventure.com/MapTiles/lcc_east_00.png", bounds[16]);
...
tiles[18] = new google.maps.GroundOverlay(
 "http://terramapadventure.com/MapTiles/lcc_east_02.png", bounds[18]);
...
tiles[20] = new google.maps.GroundOverlay(
 "http://terramapadventure.com/MapTiles/lcc_east_04.png", bounds[20]);
...
tiles[22] = new google.maps.GroundOverlay(
 "http://terramapadventure.com/MapTiles/lcc_east_06.png", bounds[22]);
...
tiles[24] = new google.maps.GroundOverlay(
 "http://terramapadventure.com/MapTiles/lcc_east_08.png", bounds[24]);
...
tiles[26] = new google.maps.GroundOverlay(
 "http://terramapadventure.com/MapTiles/lcc_east_10.png", bounds[26]);
...
tiles[28] = new google.maps.GroundOverlay(
 "http://terramapadventure.com/MapTiles/lcc_east_12.png", bounds[28]);
...
tiles[30] = new google.maps.GroundOverlay(
 "http://terramapadventure.com/MapTiles/lcc_east_14.png", bounds[30]);
